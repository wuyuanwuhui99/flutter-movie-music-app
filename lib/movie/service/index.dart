...
Future<ResponseModel<List>> getAllCategoryListByPageNameService(
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.get(
...
Future<ResponseModel<List>> getSearchResultService(String keyword,
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.get(servicePath['getSearchResult']!,
        queryParameters: {
          "keyword": keyword,
          "pageSize": pageSize,
          "pageNum": pageNum
...
Future<ResponseModel<List>> getStarService(int id) async {
  try {
    Response response = await HttpUtil.getInstance().dio.get(servicePath['getStar']! + id.toString());
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<List>> getMovieUrlService(int movieId) async {
  try {
    Response response =
    await HttpUtil.getInstance().dio.get(servicePath['getMovieUrl']!, queryParameters: {
...
Future<ResponseModel<int>> savePlayRecordService(
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.post(servicePath['savePlayRecord']!,
...
Future<ResponseModel<List>> getPlayRecordService(int pageNum,int pageSize) async {
  try {
    Response response = await HttpUtil.getInstance().dio.get('${servicePath['getPlayRecord']!}?pageNum=${pageNum.toString()}&pageSize=${pageSize.toString()}');
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<List>> getViewRecordService(int pageNum,int pageSize) async {
  try {
    Response response = await HttpUtil.getInstance().dio.get('${servicePath['getViewRecord']!}?pageNum=${pageNum.toString()}&pageSize=${pageSize.toString()}');
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<int>> saveFavoriteService(
  ...
  try {
    Response response =
    await HttpUtil.getInstance().dio.post('${servicePath['saveFavorite']!}/${movieId.toString()}', data: {});
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<List>> getFavoriteService(int pageNum,int pageSize) async {
  try {
    Response response = await HttpUtil.getInstance().dio.get('${servicePath['getFavorite']!}?pageNum=${pageNum.toString()}&pageSize=${pageSize.toString()}');
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<int>> deleteFavoriteService(int movieId) async {
  try {
    Response response = await HttpUtil.getInstance().dio.delete('${servicePath['deleteFavorite']!}/${movieId.toString()}');
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<List>> getYourLikesService(String labels) async {
  try {
    Response response = await HttpUtil.getInstance().dio
...
Future<ResponseModel<int>> getCommentCountService(
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.get(servicePath['getCommentCount']!,
...
Future<ResponseModel<List>> getTopCommentListService(
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.get(servicePath['getTopCommentList']!,
        queryParameters: {
...
Future<ResponseModel<List>> getReplyCommentListService(
  ...
  try {
    Response response = await HttpUtil.getInstance().dio.get(servicePath['getReplyCommentList']!,
        queryParameters: {
          "topId": topId,
          "pageSize": pageSize,
          "pageNum": pageNum
...
Future<ResponseModel<dynamic>> insertCommentService(Map commentMap) async {
  try {
    Response response =
    await HttpUtil.getInstance().dio.post(servicePath['insertCommentService']!, data: commentMap);
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
...
Future<ResponseModel<String>> updateAvaterService(Map avaterMap) async {
  try {
    Response response =
    await HttpUtil.getInstance().dio.put(servicePath['updateAvaterService']!, data: avaterMap);
    return ResponseModel.fromJson(response.data);
  } catch (e) {
    print('ERROR:======>${e}');
    return ResponseModel.fromJson(null);
